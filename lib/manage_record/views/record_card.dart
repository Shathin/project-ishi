...
import 'form_views/text_input_field.dart';
  ...
  Widget _buildDeleteButton() => Container(
        child: IconButton(
          ...
          icon: GestureDetector(
            onLongPress: () {
              context.read<ManageRecordBloc>().add(
                    DeleteRecordEvent(
                      deletedRecord: this.record,
                    ),
                  );
          ...
          onPressed: () {
            setState(() {
              ...
              if (!isEditing && updateRequired) {
                ...
                Patient oldPatient = (context.read<ManageRecordBloc>().state
                        as ManageRecordLoadedState)
                    .patient;
